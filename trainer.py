...
from model import G_DCGAN, G_NET, AttnDecoderRNN, DecoderRNN
...
class condGANTrainer(object):
    ...
    def build_models(self):
        ...
        #####SixingYu 20190917
        #text_decoder = AttnDecoderRNN(hidden_size=cfg.TEXT.EMBEDDING_DIM,output_size=cfg.TEXT.EMBEDDING_DIM)
        text_decoder = DecoderRNN(hidden_size=cfg.TEXT.EMBEDDING_DIM, output_size=cfg.TEXT.EMBEDDING_DIM)
        ...
        if cfg.CUDA:
            ...
            text_decoder = text_decoder.cuda()
            image_encoder = image_encoder.cuda()

            netG.cuda()
            for i in range(len(netsD)):
                netsD[i].cuda()
        return [text_encoder, text_decoder, image_encoder, netG, netsD, epoch]
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            while step < self.num_batches:
                ...
                for frame in range(num_frame):
                    de_output,de_hidden = text_decoder(de_input.transpose(0,1),de_hidden)
